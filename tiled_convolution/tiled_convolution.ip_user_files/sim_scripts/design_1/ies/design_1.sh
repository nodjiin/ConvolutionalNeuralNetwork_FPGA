...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../tiled_convolution.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../tiled_convolution.srcs/sources_1/bd/design_1/ipshared/d5d3/hdl/verilog" \
       +incdir+"$ref_dir/../../../../tiled_convolution.srcs/sources_1/bd/design_1/ipshared/e0a2/hdl" \
       +incdir+"../../../../tiled_convolution.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../tiled_convolution.srcs/sources_1/bd/design_1/ipshared/d5d3/hdl/verilog" \
       +incdir+"../../../../tiled_convolution.srcs/sources_1/bd/design_1/ipshared/e0a2/hdl" \
       +incdir+"/media/dati/dante/Xilinx/Vivado/2017.3/data/xilinx_vip/include"
}
