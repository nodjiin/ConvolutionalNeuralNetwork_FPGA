...
architecture behave of zhang_cnn_control_s_axi is
    ...
    constant ADDR_CURR_LAYER_IN_N_LAYER_DATA_0  : INTEGER := 16#30#;
    constant ADDR_CURR_LAYER_IN_N_LAYER_CTRL    : INTEGER := 16#34#;
    constant ADDR_CURR_LAYER_IN_IN_W_DATA_0     : INTEGER := 16#38#;
    constant ADDR_CURR_LAYER_IN_IN_W_CTRL       : INTEGER := 16#3c#;
    constant ADDR_CURR_LAYER_IN_IN_H_DATA_0     : INTEGER := 16#40#;
    constant ADDR_CURR_LAYER_IN_IN_H_CTRL       : INTEGER := 16#44#;
    constant ADDR_CURR_LAYER_IN_OUT_W_DATA_0    : INTEGER := 16#48#;
    constant ADDR_CURR_LAYER_IN_OUT_W_CTRL      : INTEGER := 16#4c#;
    constant ADDR_CURR_LAYER_IN_OUT_H_DATA_0    : INTEGER := 16#50#;
    constant ADDR_CURR_LAYER_IN_OUT_H_CTRL      : INTEGER := 16#54#;
    constant ADDR_CURR_LAYER_IN_IN_CH_DATA_0    : INTEGER := 16#58#;
    constant ADDR_CURR_LAYER_IN_IN_CH_CTRL      : INTEGER := 16#5c#;
    constant ADDR_CURR_LAYER_IN_OUT_CH_DATA_0   : INTEGER := 16#60#;
    constant ADDR_CURR_LAYER_IN_OUT_CH_CTRL     : INTEGER := 16#64#;
    constant ADDR_CURR_LAYER_IN_KER_W_DATA_0    : INTEGER := 16#68#;
    constant ADDR_CURR_LAYER_IN_KER_W_CTRL      : INTEGER := 16#6c#;
    constant ADDR_CURR_LAYER_IN_KER_H_DATA_0    : INTEGER := 16#70#;
    constant ADDR_CURR_LAYER_IN_KER_H_CTRL      : INTEGER := 16#74#;
    constant ADDR_CURR_LAYER_IN_KER_CH_DATA_0   : INTEGER := 16#78#;
    constant ADDR_CURR_LAYER_IN_KER_CH_CTRL     : INTEGER := 16#7c#;
    constant ADDR_CURR_LAYER_IN_STR_W_DATA_0    : INTEGER := 16#80#;
    constant ADDR_CURR_LAYER_IN_STR_W_CTRL      : INTEGER := 16#84#;
    constant ADDR_CURR_LAYER_IN_STR_H_DATA_0    : INTEGER := 16#88#;
    constant ADDR_CURR_LAYER_IN_STR_H_CTRL      : INTEGER := 16#8c#;
    constant ADDR_CURR_LAYER_IN_PAD_W_DATA_0    : INTEGER := 16#90#;
    constant ADDR_CURR_LAYER_IN_PAD_W_CTRL      : INTEGER := 16#94#;
    constant ADDR_CURR_LAYER_IN_PAD_H_DATA_0    : INTEGER := 16#98#;
    constant ADDR_CURR_LAYER_IN_PAD_H_CTRL      : INTEGER := 16#9c#;
    constant ADDR_CURR_LAYER_IN_RELU_DATA_0     : INTEGER := 16#a0#;
    constant ADDR_CURR_LAYER_IN_RELU_CTRL       : INTEGER := 16#a4#;
    constant ADDR_CURR_LAYER_IN_HAS_BIAS_DATA_0 : INTEGER := 16#a8#;
    constant ADDR_CURR_LAYER_IN_HAS_BIAS_CTRL   : INTEGER := 16#ac#;
    constant ADDR_CURR_LAYER_IN_ACT_TYPE_DATA_0 : INTEGER := 16#b0#;
    constant ADDR_CURR_LAYER_IN_ACT_TYPE_CTRL   : INTEGER := 16#b4#;
    ...
    signal int_curr_layer_in_n_layer : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_in_w : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_in_h : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_out_w : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_out_h : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_in_ch : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_out_ch : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_ker_w : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_ker_h : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_ker_ch : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_str_w : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_str_h : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_pad_w : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_pad_h : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_relu : UNSIGNED(15 downto 0) := (others => '0');
    signal int_curr_layer_in_has_bias : UNSIGNED(15 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_CURR_LAYER_IN_N_LAYER_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_n_layer(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_IN_W_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_in_w(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_IN_H_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_in_h(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_OUT_W_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_out_w(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_OUT_H_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_out_h(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_IN_CH_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_in_ch(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_OUT_CH_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_out_ch(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_KER_W_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_ker_w(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_KER_H_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_ker_h(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_KER_CH_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_ker_ch(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_STR_W_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_str_w(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_STR_H_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_str_h(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_PAD_W_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_pad_w(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_PAD_H_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_pad_h(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_RELU_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_relu(15 downto 0), 32);
                    when ADDR_CURR_LAYER_IN_HAS_BIAS_DATA_0 =>
                        rdata_data <= RESIZE(int_curr_layer_in_has_bias(15 downto 0), 32);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_N_LAYER_DATA_0) then
                    int_curr_layer_in_n_layer(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_n_layer(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_IN_W_DATA_0) then
                    int_curr_layer_in_in_w(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_in_w(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_IN_H_DATA_0) then
                    int_curr_layer_in_in_h(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_in_h(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_OUT_W_DATA_0) then
                    int_curr_layer_in_out_w(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_out_w(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_OUT_H_DATA_0) then
                    int_curr_layer_in_out_h(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_out_h(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_IN_CH_DATA_0) then
                    int_curr_layer_in_in_ch(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_in_ch(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_OUT_CH_DATA_0) then
                    int_curr_layer_in_out_ch(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_out_ch(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_KER_W_DATA_0) then
                    int_curr_layer_in_ker_w(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_ker_w(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_KER_H_DATA_0) then
                    int_curr_layer_in_ker_h(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_ker_h(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_KER_CH_DATA_0) then
                    int_curr_layer_in_ker_ch(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_ker_ch(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_STR_W_DATA_0) then
                    int_curr_layer_in_str_w(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_str_w(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_STR_H_DATA_0) then
                    int_curr_layer_in_str_h(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_str_h(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_PAD_W_DATA_0) then
                    int_curr_layer_in_pad_w(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_pad_w(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_PAD_H_DATA_0) then
                    int_curr_layer_in_pad_h(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_pad_h(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_RELU_DATA_0) then
                    int_curr_layer_in_relu(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_relu(15 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CURR_LAYER_IN_HAS_BIAS_DATA_0) then
                    int_curr_layer_in_has_bias(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_curr_layer_in_has_bias(15 downto 0));
                end if;
            end if;
        end if;
    end process;
