...
void set_tensors_config_cnn(XZhang_cnn InstancePtr, tensor_data_t *input,
	...
	XZhang_cnn_Set_bias(&InstancePtr, (u32) bias);
}
void set_fpga_cnn(XZhang_cnn InstancePtr, layer_config layer_c, tensor_data_t *input, tensor_data_t *output,
		tensor_data_t *weights,tensor_data_t *bias){

	set_layer_config_cnn(InstancePtr, layer_c);
	set_tensors_config_cnn(InstancePtr, input, output, weights,bias);
